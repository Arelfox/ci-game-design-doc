...
- ## Extraction event
	...
	- if you dont do it in time it will just leave
		- also the extraction vehicle will have to re-arm so there is a cooldown before you can call it again (also punishes missed extractions)
	- for the people like me who care about details maybe have the main ship notify the player with something like "Radar and IR jammers active. Extract in 15 seconds."
		- ideally with more personality than that lol